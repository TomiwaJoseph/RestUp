            ...
            <div className="container apartment-container">
              ...
              <div className="room-description">
                ...
                <p>
                  ...
                  Popular points of interest near the apartment include
                  StackOverflow Hall, GitHub Market Square and Google Hall
                  Tower. The nearest airport is Fly Me There International
                  Flights, 16.1 km from {apartmentSlug} Apartments, and the
                ...
                {room_details.map((room) => (
                  <div key={room.id} className="row apartment-room mx-auto">
                    ...
                    <div className="col-md-4 apartment-cta my-auto">
                      ...
                      <NavLink
                        to={`/reserve-room/${apartmentSlug}/${room.slug}`}
                      >
